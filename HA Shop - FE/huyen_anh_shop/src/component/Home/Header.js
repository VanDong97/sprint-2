                    ...
                    <div className="offcanvas-body">
                        ...
                        >
                            <li className="nav-item">
                                <Link to="/"
                                    className="nav-link me-5  border-0"
                                    aria-expanded=""
                                    style={{fontSize: 20}}
                                >
                                    Trang Chủ
                            ...
                            <li className="nav-item">
                                <Link to="/promotion" className="nav-link me-5" style={{fontSize: 20}} >
                                    Khuyến Mãi
                                </Link>
                            </li>
                            <li className="nav-item ">
                            ...
                            <li className="nav-item">
                                <div className="user-items ps-5">
                                    <ul className="d-flex justify-content-end list-unstyled">
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link" style={{ color: "red" }} onClick={() => logout()}>Đăng xuất</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
